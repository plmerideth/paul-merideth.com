<?php #Script 18.6, register.php, pg 576
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		if($fn && $ln && $e && $p)
		{
			...
			//If email address unique, register user
			if(mysqli_num_rows($r)==0) //Email address unique and OK
			{
				...
				//Send confirmation Email if registration worked
				...
				{                    
                    ...
                    $sender_name = $fn . ' ' . $ln;
					/*
					Change code for live version to use InMotion and phpMailer.
					*/
                    /*
                   myShowVar("body = ", $body);
                   myShowVar("e =", $e);
                    ...
                    */
                   if(send_mail($body, $e, $sender_name))
                   {
                    mysqli_close($dbc);
                    echo '<p>DB closed</p>';
                    echo '<h3>Thank you for registering!  A confirmation Email has been sent to your address.  Please click on the link to activate your account.</h3>';
